...
>
> **Next.js on Vite** (`@storybook/nextjs-vite`) is not called out separately: it follows every `// if using React` line, with `@storybook/react-vite` replaced by `@storybook/nextjs-vite`.
