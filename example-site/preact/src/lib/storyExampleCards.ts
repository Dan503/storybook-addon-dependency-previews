 ...
 * matches addresses the way preact-iso does, with a colon, so a shared card
 * handed straight to a listing here carries an address the site does not have.
 * Swapping the address is all that is needed: the pieces that complete it
...
import type { PropsForCardMolecule } from '../components/listings/card/CardMolecule'
