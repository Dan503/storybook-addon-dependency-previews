...
const cardArgs = {
	...
	// link component fills the address in, and a changing piece with no value
	// throws — so without these, picking `/meal/[mealId]` or
	// `/categories/[category]` from the control would fail to render rather than
	// link somewhere. The three addresses with nothing to fill ignore them.
